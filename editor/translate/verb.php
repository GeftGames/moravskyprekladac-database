<div class="splitView">
    <div>
        ...
        $sql="SELECT id, label FROM verb_patterns_to WHERE `translate`=$filter;";
        ...
        verb_to_changed=function() {             
            let id = flist_verb_pattern_to.getSelectedIdInList();
        ...
        flist_verb_pattern_to.EventItemSelectedChanged(verb_to_changed);
        flist_verb_pattern_to.EventItemAddedChanged(verb_to_added);";
    
        $GLOBALS["script"].= /** @lang JavaScript */"
        var flist_verb_pattern_to;
        var currentverbTOSave = function() {
            ...
            .then(json => {
                if (json.status==='OK') {
                   flist_verb_pattern_to.getSelectedItemInList().innerText=label;
        ...
        var verb_to_added = function() {
            flist_verb_pattern_to.lastAddedId;
            verb_to_changed();
        }";            
        ?>
    </div>
