<div class="splitView">
    <div>
       ...
       // include "components/filter_list.php";
        ...
        $sql="SELECT id, label FROM number_patterns_cs $order;";
        ...
        number_cs_changed=function() { 
            ...
            fetch('index.php', {
                ...
                body: `action=number_pattern_cs_item&id=`+id
        ...
        var currentnumberCSSave = function() {
            ...
            let tags=document.getElementById('number_csdatatags').value;
            ...
            formData.append('action', 'number_pattern_cs_update');
            ...
            .then(json => {
                if (json.status=='OK'){
                   flist_number_pattern_cs.getSelectedItemInList().innerText=label;
        ...
        var number_cs_added = function() {
            flist_number_pattern_cs.lastAddedId;
            number_cs_changed();
        }";
    ...
    <div class="editorView">
        <div id="regionsview">
            ...
            <?php echo tagsEditor("number_cs", [], "Tagy")?>
            <div> 
                <input type="hidden" id="numberId" value="-1">
                <a onclick="currentnumberCSSave()" class="button">Uložit</a>
            </div>
        </div>
    </div>
</div>