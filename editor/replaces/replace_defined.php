    ...
    <div class="editorView">
        <div id="regionsview">
            <div class="row section">
                ...
                <input type="text" id="pronounLabel" for="name" value="" placeholder="ka>kaj (přís.)" style="max-width: 9cm;">
                <a onclick="" class="button">Sestavit</a>
            </div>

            <div class="row section">
                <label id="base">Z</label><br>
                <input type="text" id="pronounBase" for="name" value="" placeholder="ka" style="max-width: 9cm;">
            </div>

            <div class="row section">
                <label id="base">Na</label><br>
                <input type="text" id="pronounBase" for="name" value="" placeholder="kaj" style="max-width: 9cm;">
            </div>

                 <div class="row section">
                <label>Druh</label>
                <select id="pronounShapesType" name="type">
            ...
            <div class="row section">
                <label for="replaceTypeNounGender">Pozice</label>
